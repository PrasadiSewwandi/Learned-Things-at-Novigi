...
class BookStoreOperator(BaseOperator):

    def __init__(self, api_url: str, req_type = "GET", output_csv = "", json_path: str = None, api_headers: dict = None, pay_load: dict = None, mapping: dict = None, *args, **kwargs):
